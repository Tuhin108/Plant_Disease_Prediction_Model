...
def download_model(): #  https://drive.google.com/file/d/1L0wnyjWiSEIc0cDyXoEHna16aMbxja55/view?usp=drive_link
    file_id = '1L0wnyjWiSEIc0cDyXoEHna16aMbxja55'  #Replace with the actual Google Drive file ID
    model_url = f'https://drive.google.com/uc?id={file_id}'  # Google Drive download URL
    output_path = 'CNN_plantdiseases_model_high.keras'
    gdown.download(model_url, output_path, quiet=False)  # Download the model file
    return output_path
